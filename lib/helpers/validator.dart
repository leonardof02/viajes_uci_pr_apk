class Validator {
  ...
  static String? validateFullName(String? value) {
    ...
    if (value != null && !nameRegex.hasMatch(value)) return "Por favor escribe nombre y apellidos";
    return null;
  }
  ...
  static String? validateCubanCI(String? value) {
    ...
    if (value != null && !idRegex.hasMatch(value)) return "Formato de Carnet de ID no valudo";
    return null;
  }
